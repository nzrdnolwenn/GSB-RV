...
public class Visiteur {
    ...
    public Visiteur(String vis_matricule, String vis_nom, String vis_prenom ,String vis_adresse, String vis_cp, String vis_ville, Date vis_dateembauche){
    ...
    public void setSec_code(String set_code) {
        this.sec_code = set_code;
    }
